          ...
          <div className='row m-0  mb-5'>
            <div className='col-lg-6 col-12 bg-secondary text-white '>
                <div className='mt-5 p-5'>
                  <h1 className='fs-2 fw-normal mb-3 fade-1' aria-label={title}>{title}</h1> 
                  ...
                  <p className='fw-light fs-1 fade-4' aria-label={description}>
                    {description}
                  </p>
                </div>
            </div>
            <div className='col-lg-6 col-12 m-0 p-0'>
              {headerImage && (
                <img src={headerImage} className='object-fit-cover w-100 vh-100 background-image' alt={`About ${companyName.first}`} />
              )}
            </div>
          </div>
        </div>
