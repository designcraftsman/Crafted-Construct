...
const BlogPostCard2 = ({ image, title, category, description, author, date, authorImage, altText }) => {
  return (
    <Card className="blog-post-card">
      <div className="row g-0">
        <div className="col-md-6 image-container">
          <Card.Img variant="top" src={image} alt={altText} className="card-image-v2" />
        </div>
        <div className="col-md-6">
          <Card.Body>
            ...
            <div className="d-flex align-items-center gap-3">
              <img src={authorImage} className="user-image" alt={`Author ${author}`} />
