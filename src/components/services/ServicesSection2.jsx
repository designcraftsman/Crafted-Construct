    ...
    return(
        <div className="container my-5 reveal-section" ref={sectionRef}>
            ...
            <div className="row my-5 gap-3 d-flex justify-content-evenly">
                <div className="col-3 bg-white border text-center p-3 rounded reveal-element reveal-3">
                    <MdOutlineBuild className="display-3 text-primary" />
                ...
                <div className="col-3 bg-white border text-center p-3 rounded reveal-element reveal-4">
                    <MdOutlineBuild className="display-3 text-primary" />
                    <h4 className="fw-bold my-3">
                    Construction
                    </h4>
                ...
                <div className="col-3 bg-white border text-center p-3 rounded reveal-element reveal-5">
                    <MdOutlineBuild className="display-3 text-primary" />
                    <h4 className="fw-bold my-3">
                    Construction
                    </h4>
